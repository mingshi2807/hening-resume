  ...
  return <main className="resume-document space-y-8 print:space-y-0">
    ...
    <section className="resume-page grid grid-cols-[34.5%_65.5%]">
      ...
      <article className="resume-content p-[12mm_10mm_8mm]">
        ...
        <div className="space-y-4">
          ...
          <Job compact title="审计主管" company="成都苑东生物制药" period="2019.04 – 2022.04" lead="全面负责审计职能规划与执行，深度参与科创板上市筹备，作为审计模块核心接口推进 ICFR 合规测试。" highlights={["科创板上市筹备", "ICFR 合规测试"]} groups={[{title:'上市合规与制度建设', bullets:['主导审计制度、SOP 及招标管理等关键流程更新与合规化。','独立完成年度内部控制评价报告及管理审计报告。','建立采购价格库与招投标数据库，以数据分析支撑成本核算合规。']}]} />
        </div>
      </article>
    </section>
    ...
    <section className="resume-page grid grid-cols-[34.5%_65.5%]">
      ...
      <article className="resume-content p-[10mm_10mm_12mm]">
        <SectionHeading eyebrow="EXPERIENCE">核心经历（续）</SectionHeading>
        <Job compact title="审计主管（续）" company="成都苑东生物制药" period="2019.04 – 2022.04" lead="以风险为导向统筹全面审计实施与外部协同，确保关键财务报告流程得到有效覆盖。" highlights={["关键流程全覆盖", "0 重大缺陷"]} groups={[
